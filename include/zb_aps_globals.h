...
#define ZB_APS_CLEAR_ZDO_ED_SCAN_FLAG() (ZG->aps.flags &= \
                                             ~ZB_APS_ZDO_ED_SCAN_MASK)
#define ZB_APS_GET_ZDO_ED_SCAN_FLAG() (ZG->aps.flags & ZB_APS_ZDO_ED_SCAN_MASK)

#define ZB_APS_SET_CHANNEL_MANAGER_ED_SCAN_FLAG() (ZG->aps.flags |= \
                                                       ZB_APS_CHANNEL_MANAGER_ED_SCAN_MASK)
#define ZB_APS_CLEAR_CHANNEL_MANAGER_ED_SCAN_FLAG() (ZG->aps.flags &= \
                                                         ~ \
                                                         ZB_APS_CHANNEL_MANAGER_ED_SCAN_MASK)
