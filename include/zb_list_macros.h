 ...
 */
#define ZB_LIST_PREV_FOR_ITER(ent, \
                              name) ((((ent)->name ## _prev)->name ## _next) ? ( \
                                         ent)->name ## _prev : 0)
    ...
    {                                                                       \
        ...
        {                                                                     \
            ...
            {                                                                   \
                ...
                ((list)->name ## _prev)->name ## _next = \
                    ((list)->name ## _prev)->name ## _prev; \
...
#define ZB_LIST_ITERATE_BACK(list, name, ent) \
    for ((ent) = (list) ? (list)->name ## _prev : 0; (ent); \
         (ent) = \
             (((ent)->name ## _prev)->name ## _next) ? (ent)->name ## _prev : 0)
...
#define ZB_SL_LIST_ITERATE(list, name, ent) for ((ent) = (list ## _head); (ent); \
                                                 (ent) = (ent)->name ## _next)
