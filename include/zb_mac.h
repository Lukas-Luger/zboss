 ...
 */
#define ZB_MAC_SUPPORTED_CHANNELS   (ZB_MAC_MAX_CHANNEL_NUMBER - \
                                     ZB_MAC_START_CHANNEL_NUMBER + 1)
 ...
 */
#define ZB_MAC_BASE_SUPERFRAME_DURATION ZB_MAC_BASE_SLOT_DURATION * \
    ZB_MAC_NUM_SUPERFRAME_SLOTS                                                                 /* = 960 */
...
#define ZB_MAC_START_ACK_WAITING() \
    {                                                                       \
        ...
        ZB_SCHEDULE_ALARM(zb_mac_ack_timeout, 0, \
...
#define ZB_FCF_SET_FRAME_TYPE( p_fcf, frame_type )                                 \
    ...
    {                                                                                  \
        ...
        ((( zb_uint8_t * )(p_fcf))[ZB_PKT_16B_ZERO_BYTE]) |= \
            (zb_uchar_t)(frame_type); \
    } while (0)
...
#define ZB_FCF_GET_FRAME_TYPE( p_fcf ) ((zb_uint_t)(((( zb_uint8_t * )(p_fcf))[ \
                                                         ZB_PKT_16B_ZERO_BYTE]) \
                                                    & 0x07))
...
#define ZB_FCF_GET_SECURITY_BIT( p_fcf ) ((zb_uint_t)(((( zb_uint8_t * )(p_fcf)) \
                                                       [ZB_PKT_16B_ZERO_BYTE]) & \
                                                      0x08))
...
#define ZB_FCF_GET_FRAME_PENDING_BIT( p_fcf ) ((zb_uint_t)(((( zb_uint8_t * )( \
                                                                 p_fcf))[ \
                                                                ZB_PKT_16B_ZERO_BYTE \
                                                            ]) & 0x10))
...
#define ZB_FCF_GET_ACK_REQUEST_BIT( p_fcf ) ((zb_uint_t)(((( zb_uint8_t * )( \
                                                               p_fcf))[ \
                                                              ZB_PKT_16B_ZERO_BYTE \
                                                          ]) & 0x20))
...
#define ZB_FCF_GET_PANID_COMPRESSION_BIT( p_fcf ) ((zb_uint_t)(((( zb_uint8_t * )( \
                                                                     p_fcf))[ \
                                                                    ZB_PKT_16B_ZERO_BYTE \
                                                                ]) & 0x40))
...
#define ZB_FCF_GET_FRAME_VERSION( p_fcf )  (((zb_uint_t)(((( zb_uint8_t * )( \
                                                               p_fcf))[ \
                                                              ZB_PKT_16B_FIRST_BYTE \
                                                          ]) & 0x30)) >> 4)
...
#define ZB_FCF_SET_FRAME_VERSION( p_fcf, frame_version )        \
    ...
    {                                                               \
        ...
        ((( zb_uint8_t * )(p_fcf))[ZB_PKT_16B_FIRST_BYTE]) |= (frame_version) << \
                                                              4;  \
    } while (0)
...
#define ZB_FCF_GET_SRC_ADDRESSING_MODE( p_fcf )  (((zb_uint_t)(((( zb_uint8_t * )( \
                                                                     p_fcf))[ \
                                                                    ZB_PKT_16B_FIRST_BYTE \
                                                                ]) & 0xC0)) >> \
                                                  6)
...
#define ZB_FCF_GET_DST_ADDRESSING_MODE( p_fcf )  (((zb_uint_t)(((( zb_uint8_t * )( \
                                                                     p_fcf))[ \
                                                                    ZB_PKT_16B_FIRST_BYTE \
                                                                ]) & 0x0C)) >> \
                                                  2)
 ...
 */
#define ZB_MCPS_BUILD_DATA_REQUEST(buf, src_addr_param, dst_addr_param, \
                                   tx_options_param, msdu_hande_param) \
    {                                                                     \
...
#define ZB_MAC_CUT_FCS(packet) ZB_BUF_CUT_RIGHT(packet, \
                                                ZB_TAIL_SIZE_FOR_SENDER_MAC_FRAME);
#else
#define ZB_MAC_CUT_FCS(packet)
#define ZB_TAIL_SIZE_FOR_SENDER_MAC_FRAME 0
#endif

#define ZB_BEACON_PAYLOAD_OFFSET(mhr_len) ((mhr_len) + SUREPFRAME_SPEC_LENGTH + \
                                           1 /*GTS*/ + \
                                           1 /*pending address specification*/)
#define ZB_BEACON_PAYLOAD_TAIL (ZB_TAIL_SIZE_FOR_SENDER_MAC_FRAME + \
                                ZB_MAC_EXTRA_DATA_SIZE)
...
#define ZB_MAC_CUT_HDR_WITHOUT_TRAILER(_packet, _ptr)               \
    ...
    {                                                                 \
        ...
        ZB_BUF_CUT_LEFT(_packet,                                         \
                        hlen + MAC_SECUR_LEV5_KEYID1_AUX_HDR_SIZE * ZB_FCF_SET_SECURITY_BIT( \
                            mac_hdr), \
                        _ptr);                                                         \
    } while (0)
#endif
...
#define ZB_MAC_CUT_HDR_WITHOUT_TRAILER(_packet, _ptr)               \
    ...
    {                                                                 \
        ...
        hlen = zb_mac_calculate_mhr_length(                             \
            ...
            ZB_FCF_GET_DST_ADDRESSING_MODE(mac_hdr),                      \
            ZB_FCF_GET_PANID_COMPRESSION_BIT(mac_hdr));                   \
        ZB_BUF_CUT_LEFT(_packet, hlen + MAC_SECUR_LEV5_KEYID1_AUX_HDR_SIZE * ZB_FCF_GET_SECURITY_BIT( \
                            mac_hdr), _ptr);                                        \
                                        \
                                                                  \
    } while (0)
...
/**
   ...
   on when idle.
 */
#define ZB_MAC_CAP_SET_ROUTER_CAPS(cap) ((cap) |= (1 << 1) | (1 << 2) | \
                                                  (1 << 3))
...
#define ZB_MLME_BUILD_ASSOCIATE_REQUEST( buf,                           \
    ...
    do                                                                      \
    {                                                                       \
        zb_mlme_associate_params_t *_p = \
            (zb_mlme_associate_params_t *)ZB_GET_BUF_PARAM((buf), \
                                                           zb_mlme_associate_params_t); \
        ...
        {                                                                     \
            ZB_MEMCPY(&_p->coord_addr.addr_short, (p_address), \
                      sizeof(zb_uint16_t)); \
        }                                                                     \
...
#define ZB_MLME_BUILD_ASSOCIATE_RESPONSE( buf,                          \
    ...
    do                                                                      \
    {                                                                       \
        zb_mlme_associate_response_t *p = \
            (zb_mlme_associate_response_t *)ZB_GET_BUF_PARAM((buf), \
                                                             zb_mlme_associate_response_t); \
...
#define ZB_SUPERFRAME_SET_SUPERFRAME_ORDER(superframe, superframe_order) \
    ...
    {                                                                     \
        ...
        ((zb_uint8_t *)(superframe))[ZB_PKT_16B_ZERO_BYTE] |= \
            (superframe_order) << 4; \
    } while (0)
...
#define ZB_SUPERFRAME_SET_ASS_PERMIT(superframe, ass_permit)            \
    ...
    {                                                                     \
        ...
        ((zb_uint8_t *)(superframe))[ZB_PKT_16B_FIRST_BYTE] |= (ass_permit) << \
                                                               7;   \
    } while (0)
...
#define ZB_MAC_GET_BEACON_PAYLOAD(mhr, mhr_len, beacon_payload_p )        \
    beacon_payload_p = \
        (void *)(((zb_uint8_t *)mhr) + mhr_len + SUREPFRAME_SPEC_LENGTH \
                 + 1 /*GTS*/ + \
                 1 /*pending address specification*/)
...
#define ZB_MAC_GET_BEACON_ORDER( p_sfs ) ((zb_uint_t)((((zb_uint8_t *)(p_sfs))[ \
                                                           ZB_PKT_16B_ZERO_BYTE]) \
                                                      & 0x07))
...
#define ZB_MAC_GET_ASSOCIATION_PERMIT( p_sfs ) ((zb_uint_t)((((zb_uint8_t *)( \
                                                                  p_sfs))[ \
                                                                 ZB_PKT_16B_FIRST_BYTE \
                                                             ] >> 7) & 1))
...
#define ZB_MAC_GET_SUPERFRAME_ORDER( p_sfs ) ((zb_uint_t)((((zb_uint8_t *)(p_sfs)) \
                                                           [ZB_PKT_16B_ZERO_BYTE \
                                                           ] >> 4) & 0xF))
...
#define ZB_MAC_GET_SUPERFRAME_PAN_COORDINATOR( p_sfs ) ((zb_uint_t)(((( \
                                                                          zb_uint8_t \
                                                                          *)( \
                                                                          p_sfs)) \
                                                                     [ \
...
#define ZB_MLME_BUILD_SCAN_REQUEST( buf, _channels, type, duration)                                  \
    do                                                                                                   \
    {                                                                                                    \
        zb_mlme_scan_params_t *_p = \
            (zb_mlme_scan_params_t *)ZB_GET_BUF_PARAM((buf), \
                                                      zb_mlme_scan_params_t); \
...
zb_ret_t zb_mac_get_indirect_data(
    zb_mlme_data_req_params_t *data_req_cmd_params) ZB_CALLBACK;
 ...
 */
zb_ret_t zb_mac_send_comm_status(zb_buf_t *pending_buf, zb_uint8_t mac_status,
                                 zb_buf_t *buffer) ZB_SDCC_REENTRANT;
...
zb_ret_t zb_mac_setup_for_associate(zb_uint8_t logical_channel,
                                    zb_uint16_t pan_id,
...
#define ZB_MAC_PIB_RESPONSE_WAIT_TIME ZB_MAC_RESPONSE_WAIT_TIME * \
    ZB_DEBUG_ENLARGE_TIMEOUT
#define ZB_MAC_PIB_ACK_WAIT_DURATION (ZB_UINT_BACKOFF_PERIOD + \
                                      ZB_TURNAROUND_TIME + ZB_PHY_SHR_DURATION + \
                                      (zb_uint16_t)(6 * \
                                                    ZB_PHY_SYMBOLS_PER_OCTET))
#define ZB_MAC_PIB_TRANSACTION_PERSISTENCE_TIME \
...
#define ZB_MAC_PIB_TRANSACTION_PERSISTENCE_TIME MAC_PIB(). \
    mac_transaction_persistence_time
#define ZB_MAC_PIB_MAX_FRAME_TOTAL_WAIT_TIME MAC_PIB(). \
