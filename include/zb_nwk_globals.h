...
#define ZB_NWK_BRCST_PASSIVE_ACK_ARRAY_SIZE (ZB_NEIGHBOR_TABLE_SIZE / 8 + \
...
#define ZB_NWK_BROADCAST_DELIVERY_TIME() (2 * ZG->nwk.nib.max_depth * \
                                          (/*0.05 +*/ \
                                              ZB_NWK_MAX_BROADCAST_JITTER / 2 \
                                              + \
                                              ZG->nwk.nib. \
                                              passive_ack_timeout * \
                                              ZB_MWK_INITIAL_RREQ_RETRIES / \
                                              1000))
#endif
