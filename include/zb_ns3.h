...
zb_ret_t zb_mac_ns_send_packet(zb_buf_t *buf,
                               zb_bool_t release_buf) ZB_SDCC_REENTRANT;
...
#define ZB_TRANSCEIVER_SET_CHANNEL(channel_number) (MAC_CTX().current_channel = \
                                                        channel_number, 0)
