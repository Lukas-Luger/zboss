...
#define ZB_POOLED_LIST8_FIELD( link_field )  unsigned char link_field ## _next; \
    unsigned char link_field ## _prev
#define ZB_POOLED_LIST16_FIELD( link_field ) unsigned short link_field ## _next; \
    unsigned short link_field ## _prev
...
#define ZB_POOLED_LIST8_NEXT( base, index, \
                              link_field ) ((ZP_NULL8 == \
                                             index)) ? ZP_NULL8 :  base[ index ] \
    .link_field ## _next))
#define ZB_POOLED_LIST8_PREV( base, index, \
                              link_field ) ((ZP_NULL8 == \
                                             index)) ? ZP_NULL8 :  base[ index ] \
    .link_field ## _prev))

#define ZB_POOLED_LIST8_GET_HEAD( base, list, link_field ) (list)
#define ZB_POOLED_LIST8_GET_TAIL( base, list, \
                                  link_field ) ((ZP_NULL8 != \
                                                 list) ? base[ list ].link_field \
                                                ## _prev : ZP_NULL8)

#define ZB_POOLED_LIST16_GET_HEAD( base, list, link_field ) (list)
#define ZB_POOLED_LIST16_GET_TAIL( base, list, \
                                   link_field ) ((ZP_NULL16 != \
                                                  list) ? base[ list ]. \
                                                 link_field ## _prev : ZP_NULL16)

#define ZB_POOLED_LIST16_NEXT( base, index, \
                               link_field ) ((ZP_NULL16 == \
                                              index)) ? ZP_NULL16 :  base[ index \
].link_field ## _next))
#define ZB_POOLED_LIST16_PREV( base, index, \
                               link_field ) ((ZP_NULL16 == \
                                              index)) ? ZP_NULL16 :  base[ index \
].link_field ## _prev))
...
#define ZB_POOLED_LIST8_CUT_HEAD( base, list, link_field, \
                                  removed_elem_index ) do \
    {                                                                       \
...
#define ZB_POOLED_LIST8_INSERT_HEAD( base, list, link_field, elem_index ) do \
    {                                                                       \
        ...
        if ((list) != ZP_NULL8)                                            \
        {                                                                      \
            base[ elem_index ].link_field ## _prev = \
                base[ list ].link_field ## _prev; \
...
#define ZB_POOLED_LIST8_INSERT_AFTER( base, list, link_field, elem_index, \
                                      new_elem_index ) do \
    {                                                                       \
        ...
        {                                                                     \
            if (elem_index == \
                ZB_POOLED_LIST8_GET_TAIL( base, list, link_field )) \
            {                                                                   \
                ZB_POOLED_LIST8_INSERT_TAIL( base, list, link_field, \
                                             new_elem_index ); \
            }                                                                   \
            else                                                                \
            {                                                                   \
                base[ new_elem_index ].link_field ## _next = \
                    base[ elem_index ].link_field ## _next; \
                base[ new_elem_index ].link_field ## _prev = elem_index;            \
                base[ base[ elem_index ].link_field ## _next ].link_field ## \
                _prev = new_elem_index; \
...
#define ZB_POOLED_LIST8_REMOVE_TAIL( base, list, link_field ) do        \
    {                                                                       \
        ...
        {                                                                     \
            ...
            {                                                                   \
                base[ base[ base[ list ].link_field ## _prev ].link_field ## \
                      _prev ].link_field ## _next = ZP_NULL8; \
                                                                        \
                ...
                base[ base[ list ].link_field ## _prev ].link_field ## _prev = \
                    ZP_NULL8; \
                                                                        \
                base[ list ].link_field ## _prev = \
                    base[ base[ list ].link_field ## _prev  ].link_field ## \
                    _next; \
            }                                                                   \
        }                                                                     \
    } while (0)
...
#define ZB_POOLED_LIST8_ITERATE( base, list, link_field, elem_index )   \
    for ((elem_index) = (list); (elem_index != ZP_NULL8); \
         (elem_index) = base[ elem_index ].link_field ## _next)
...
#define ZB_POOLED_LIST8_ITERATE_BACK( base, list, link_field, elem_index) \
    for ((elem_index) = (list) ? base[ list ].link_field ## _prev : ZP_NULL8; \
         (elem_index != ZP_NULL8);                                                  \
         (elem_index) = \
             ((base[ base[ elem_index ].link_field ## _prev ].link_field ## \
               _next != \
               ZP_NULL8) ? \
...
#define ZB_POOLED_LIST8_REMOVE( base, list, link_field, elem_index )    \
    ...
    {                                                                       \
        ...
        {                                                                     \
            ...
            {                                                                   \
                base[ base[ elem_index ].link_field ## _next ].link_field ## \
                _prev = base[ elem_index ].link_field ## _prev; \
            }                                                                   \
            else                  /* this is a tail */                  \
            {                                                                   \
                base[ list ].link_field ## _prev = \
            ...
            {                                                                   \
                base[ base[ elem_index ].link_field ## _prev ].link_field ## \
                _next = base[ elem_index ].link_field ## _next; \
            }                                                                   \
            base[ elem_index ].link_field ## _prev = ZP_NULL8;                    \
        }                                                                     \
    }                                                                       \
 ...
 * Remove element from the list head, and store it in removed_entry
 */
#define ZB_POOLED_LIST16_CUT_HEAD( base, list, link_field, \
                                   removed_elem_index ) do \
    {                                                                       \
...
#define ZB_POOLED_LIST16_INSERT_AFTER( base, list, link_field, elem_index, \
                                       new_elem_index ) do \
    {                                                                       \
        ...
        {                                                                     \
            if (elem_index == \
                ZB_POOLED_LIST16_GET_TAIL( base, list, link_field )) \
            {                                                                   \
                ZB_POOLED_LIST16_INSERT_TAIL( base, list, link_field, \
                                              new_elem_index ); \
            }                                                                   \
            else                                                                \
            {                                                                   \
...
#define ZB_POOLED_LIST16_REMOVE_TAIL( base, list, link_field ) do       \
    {                                                                       \
        ...
        {                                                                     \
            ...
            {                                                                   \
                base[ base[ base[ list ].link_field ## _prev ].link_field ## \
                      _prev ].link_field ## _next = ZP_NULL16; \
                                                                        \
                /* This is a bit tricky: we need to assign list->prev and set \
                 * tail->prev to 0, but we can't use temporary variable because \
                 * we have no type here. Use _next as temporary variable. */\
...
#define ZB_POOLED_LIST16_ITERATE( base, list, link_field, elem_index )   \
    for ((elem_index) = (list); (elem_index != ZP_NULL16); \
         (elem_index) = base[ elem_index ].link_field ## _next)
...
#define ZB_POOLED_SL_LIST8_DEFINE(type, list) type list ## _head; \
    type list ## _tail

#define ZB_POOLED_SL_LIST8_INIT(list) list ## _head = ZP_POOLED_SL_LIST8_NULL; \
...
#define ZB_POOLED_SL_LIST8_NEXT(base, index, \
                                name) (((index) == \
                                        ZP_POOLED_SL_LIST8_NULL) ? \
                                       ZP_POOLED_SL_LIST8_NULL : (base)[index]. \
                                       name ## \
                                       _next)
...
#define ZB_POOLED_SL_LIST8_IS_EMPTY(list) (list ## _head == \
                                           ZP_POOLED_SL_LIST8_NULL)
#define ZB_POOLED_SL_LIST8_IS_NOT_EMPTY(list) (list ## _head != \
                                               ZP_POOLED_SL_LIST8_NULL)
...
#define ZB_POOLED_SL_LIST8_ITERATE(base, list, name, index)             \
    for ((index) = (list); (index != ZP_POOLED_SL_LIST8_NULL); \
         (index) = base[index].name ## _next)
