 ...
 */
#define ZB_NWK_COMMAND_STATUS_FRAME_SECURITY_FAILED \
...
#define ZB_NWK_COMMAND_STATUS_IS_SECURE(st) \
    ((st) == ZB_NWK_COMMAND_STATUS_BAD_FRAME_COUNTER || \
     (st) == ZB_NWK_COMMAND_STATUS_BAD_KEY_SEQUENCE_NUMBER)
 ...
 */
#define ZB_NWK_UPDATE_ID1_GE_ID2(id1, \
                                 id2) (((zb_uint8_t)(id1) - (zb_uint8_t)(id2)) < \
                                       NWK_UPDATE_ID_MIDDLE)

/**
   @return true if id1 < id2, taking overflow into account
 */
#define ZB_NWK_UPDATE_ID1_LT_ID2(id1, \
                                 id2) (((zb_uint8_t)(id1) - (zb_uint8_t)(id2)) > \
                                       NWK_UPDATE_ID_MIDDLE)
...
/**
   ...
   @param t - frame type.
 */
#define ZB_NWK_FRAMECTL_SET_FRAME_TYPE(fctl, \
                                       t ) ((fctl)[ZB_PKT_16B_ZERO_BYTE] |= (t))
...
/**
   ...
   @param fctl - Frame Control Field of NWK header
 */
#define ZB_NWK_FRAMECTL_GET_PROTOCOL_VERSION(fctl) (((fctl)[ZB_PKT_16B_ZERO_BYTE \
                                                     ] >> 2) & 0xf)
 ...
 */
#define ZB_NWK_FRAMECTL_SET_PROTOCOL_VERSION(fctl, \
                                             v) ((fctl)[ZB_PKT_16B_ZERO_BYTE] |= \
                                                     ((v) << 2))

#define ZB_NWK_FRAMECTL_SET_FRAME_TYPE_N_PROTO_VER(fctl, t, \
                                                   v) ((fctl)[ \
...
/**
   ...
   @param fctl - Frame Control Field of NWK header
 */
#define ZB_NWK_FRAMECTL_GET_DISCOVER_ROUTE(fctl) (((fctl)[ZB_PKT_16B_ZERO_BYTE] \
                                                   >> 5) & 3)
 ...
 */
#define ZB_NWK_FRAMECTL_SET_DISCOVER_ROUTE(fctl, \
                                           r) ((fctl)[ZB_PKT_16B_ZERO_BYTE] |= \
                                                   ((r) << 6))
...
/**
   ...
   @param fctl - Frame Control Field of NWK header
 */
#define ZB_NWK_FRAMECTL_GET_MULTICAST_FLAG(fctl) (((fctl)[ZB_PKT_16B_FIRST_BYTE]) \
                                                  & 1)
 ...
 */
#define ZB_NWK_FRAMECTL_SET_MULTICAST_FLAG(fctl, \
                                           m) ((fctl)[ZB_PKT_16B_FIRST_BYTE] |= \
                                                   (m))
 ...
 */
#define ZB_NWK_FRAMECTL_SET_SECURITY(fctl, \
                                     s) ((fctl)[ZB_PKT_16B_FIRST_BYTE] |= \
                                             ((s) << 1))
...
/**
   ...
   @param fctl - Frame Control Field of NWK header
 */
#define ZB_NWK_FRAMECTL_GET_SOURCE_ROUTE(fctl) (((fctl)[ZB_PKT_16B_FIRST_BYTE] \
                                                 >> 2) & 1)
 ...
 */
#define ZB_NWK_FRAMECTL_SET_SOURCE_ROUTE(fctl, \
                                         s) ((fctl)[ZB_PKT_16B_FIRST_BYTE] |= \
                                                 ((s) << 2))
...
/**
   ...
   @param fctl - Frame Control Field of NWK header
 */
#define ZB_NWK_FRAMECTL_GET_DESTINATION_IEEE(fctl) (((fctl)[ \
 ...
 */
#define ZB_NWK_FRAMECTL_SET_DESTINATION_IEEE(fctl, \
                                             d) ((fctl)[ZB_PKT_16B_FIRST_BYTE] \
                                                     |= ((d) << 3))
...
/**
   ...
   @param fctl - Frame Control Field of NWK header
 */
#define ZB_NWK_FRAMECTL_GET_SOURCE_IEEE(fctl) (((fctl)[ZB_PKT_16B_FIRST_BYTE] >> \
                                                4) & 1)
/**
 ...
 */
#define ZB_NWK_FRAMECTL_SET_SOURCE_IEEE(fctl, \
                                        s) ((fctl)[ZB_PKT_16B_FIRST_BYTE] |= \
                                                ((s) << 4))


#define ZB_NWK_FRAMECTL_SET_SRC_DEST_IEEE(fctl, s, \
                                          d) ((fctl)[ZB_PKT_16B_FIRST_BYTE] |= \
                                                  (((d) << 3) | ((s) << 4)))
...
/**
   ...
   @return header part size
 */
#define ZB_NWK_HALF_HDR_SIZE(is_multicast) (ZB_OFFSETOF(zb_nwk_hdr_t, \
                                                        src_ieee_addr) + \
                                            ((is_multicast) ? 1 : 0))
...
/**
   ...
   @return header part size
 */
#define ZB_NWK_FULL_HDR_SIZE(is_multicast) (ZB_OFFSETOF(zb_nwk_hdr_t, \
                                                        mcast_control) + \
                                            ((is_multicast) ? 1 : 0))
 ...
 */
#define ZB_NWK_CMD_FRAME_GET_CMD_ID(buf, \
                                    nwk_hdr_size) (*(zb_nwk_cmd_t *)( \
                                                       ZB_BUF_BEGIN(buf) + \
                                                       (nwk_hdr_size)))
 ...
 */
#define ZB_NWK_CMD_FRAME_GET_CMD_PAYLOAD(buf, \
                                         nwk_hdr_size) ((zb_uint8_t *)( \
                                                            ZB_BUF_BEGIN(buf) + \
                                                            (nwk_hdr_size)) + 1)
...
#define ZB_NWK_REPORT_IS_PANID_CONFLICT(options) (ZB_NWK_REPORT_COMMAND_ID( \
                                                      options) == 0)
