...
/**
   ...
   @endcode
 */
void zb_zdo_match_desc_req(zb_uint8_t param,
 ...
 */
typedef zb_zdo_system_server_discovery_req_t
...
/**
   ...
   @endcode
 */
void zb_zdo_system_server_discovery_req(zb_uint8_t param,
                                        zb_callback_t cb) ZB_SDCC_REENTRANT;
...
/* bits 2 - 3, mask 0xC */
#define ZB_ZDO_RECORD_SET_RX_ON_WHEN_IDLE(var, type) (var &= ~0xC, \
                                                      var |= (type << 2))
#define ZB_ZDO_RECORD_GET_RX_ON_WHEN_IDLE(var) ((var & 0xC) >> 2)

/* bits 4 - 6, mask 0x70 */
#define ZB_ZDO_RECORD_SET_RELATIONSHIP(var, type) (var &= ~0x70, \
                                                   var |= (type << 4))
...
/**
   ...
   @param fc - APS FC of the response
 */
void zdo_device_ieee_addr_res(zb_uint8_t param,
                              zb_uint8_t fc) ZB_SDCC_REENTRANT;
...
/**
   ...
   @param cp    - user's function to call when got response from the remote.
 */
void zb_zdo_mgmt_permit_joining_req(zb_uint8_t param,
                                    zb_callback_t cb) ZB_SDCC_REENTRANT;
...
#define ZB_GET_SIMPLE_DESC_RESP(a) \
    ...
    {                               \
        ...
        zb_uint8_t _i; \
        counter =                   \
            *((zb_uint8_t *)(((zb_zdo_simple_desc_resp_t *)(a))->simple_desc. \
                             app_cluster_list + \
                             ((zb_zdo_simple_desc_resp_t *)(a))->simple_desc. \
                             app_input_cluster_count) \
              - 1); \
        TRACE_MSG(TRACE_APS1, "simple_desc_counter %hd", (FMT__H, counter)); \
        ZB_MEMMOVE( \
            ((zb_zdo_simple_desc_resp_t *)(a))->simple_desc.app_cluster_list, \
            &((zb_zdo_simple_desc_resp_t *)(a))->simple_desc.app_output_cluster_count, \
            ((zb_zdo_simple_desc_resp_t *)(a))->simple_desc.app_input_cluster_count * \
            sizeof(zb_uint16_t)); \
        ((zb_zdo_simple_desc_resp_t *)(a))->simple_desc.app_output_cluster_count \
            = counter; \
        for (_i = \
