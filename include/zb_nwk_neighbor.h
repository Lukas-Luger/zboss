    ...
    {                                                                       \
        ...
        {                                                                     \
            if (ZG->nwk.neighbor.base_neighbor[_i].used                        \
                && (ZG->nwk.neighbor.base_neighbor[_i].device_type == \
...
#define ZB_NWK_NEIGHBOR_GET_INDEX_BY_ADDRESS(addr) (addr - \
                                                    &ZG->nwk.neighbor. \
                                                    base_neighbor[0])
...
/**
   ...
   if error
 */
zb_ret_t zb_nwk_neighbor_get(zb_address_ieee_ref_t addr_ref,
