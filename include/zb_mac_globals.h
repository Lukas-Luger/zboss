...
ZB_RING_BUFFER_DECLARE( zb_mac_out_request, zb_mac_request_t,
                        ZB_MAC_MAX_REQUESTS );
...
#define ZB_MAC_SET_DEVICE_TYPE(device_type) (ZG->mac.mac_ctx.dev_type = \
                                                 (device_type))
...
#define ZB_GET_MAC_STATUS() (zb_mac_status_t)((zb_uint8_t)ZG->mac.mac_ctx. \
                                              mac_status + 0)
...
#define ZB_MAC_SET_SECURITY_PROCESS()  (MAC_CTX().mac_flags2 |= \
                                            ZB_MAC_SECURITY_PROCESS)
#define ZB_MAC_GET_SECURITY_PROCESS()  (MAC_CTX().mac_flags2 & \
                                        ZB_MAC_SECURITY_PROCESS)
#define ZB_MAC_CLEAR_SECURITY_PROCESS()  (MAC_CTX().mac_flags2 &= \
                                              ~ZB_MAC_SECURITY_PROCESS)




#define ZB_MAC_SET_ACK_TIMEOUT()   (MAC_CTX().mac_flags |= \
                                        ZB_MAC_ACK_TIMEOUT_MASK)
#define ZB_MAC_GET_ACK_TIMEOUT()   (MAC_CTX().mac_flags & \
                                    ZB_MAC_ACK_TIMEOUT_MASK)
#define ZB_MAC_CLEAR_ACK_TIMEOUT() (MAC_CTX().mac_flags &= \
                                        ~ZB_MAC_ACK_TIMEOUT_MASK)
...
#define ZB_MAC_CLEAR_ACK_FAIL()    (MAC_CTX().mac_flags &= \
                                        ~ZB_MAC_ACK_FAIL_MASK)
#define ZB_MAC_CLEAR_ACK_STATUS()  (MAC_CTX().mac_flags &= \
                                        ~(ZB_MAC_ACK_OK_MASK | \
                                          ZB_MAC_ACK_FAIL_MASK))
#define ZB_MAC_SET_PENDING_DATA()  (MAC_CTX().mac_flags |= \
                                        ZB_MAC_PEND_DATA_MASK)
#define ZB_MAC_GET_PENDING_DATA()  (MAC_CTX().mac_flags & ZB_MAC_PEND_DATA_MASK)
#define ZB_MAC_CLEAR_PENDING_DATA() (MAC_CTX().mac_flags &= \
                                         ~ZB_MAC_PEND_DATA_MASK)
...
#define ZB_MAC_SET_ASS_REQUEST()   (MAC_CTX().mac_flags |= \
                                        ZB_MAC_ASS_REQUEST_MASK)
#define ZB_MAC_GET_ASS_REQUEST()   (MAC_CTX().mac_flags & \
                                    ZB_MAC_ASS_REQUEST_MASK)
#define ZB_MAC_CLEAR_ASS_REQUEST() (MAC_CTX().mac_flags &= \
                                        ~ZB_MAC_ASS_REQUEST_MASK)

#define ZB_MAC_SET_ACK_NEEDED()              (MAC_CTX().mac_flags2 |= \
                                                  ZB_MAC_ACK_NEEDED_MASK)
#define ZB_MAC_GET_ACK_NEEDED()              (MAC_CTX().mac_flags2 & \
                                              ZB_MAC_ACK_NEEDED_MASK)
#define ZB_MAC_CLEAR_ACK_NEEDED()            (MAC_CTX().mac_flags2 &= \
                                                  ~ZB_MAC_ACK_NEEDED_MASK)

#define ZB_MAC_SET_INDIRECT_DATA_REQUEST()   (MAC_CTX().mac_flags |= \
                                                  ZB_MAC_INDIRECT_DATA_REQUEST_MASK)
#define ZB_MAC_GET_INDIRECT_DATA_REQUEST()   (MAC_CTX().mac_flags & \
                                              ZB_MAC_INDIRECT_DATA_REQUEST_MASK)
#define ZB_MAC_CLEAR_INDIRECT_DATA_REQUEST() (MAC_CTX().mac_flags &= \
                                                  ~ \
                                                  ZB_MAC_INDIRECT_DATA_REQUEST_MASK)

#define ZB_MAC_SET_IO_IN_USE()      (MAC_CTX().mac_flags2 |= \
                                         ZB_MAC_IO_IN_USE_MASK)
#define ZB_MAC_GET_IO_IN_USE()      (MAC_CTX().mac_flags2 & \
                                     ZB_MAC_IO_IN_USE_MASK)
#define ZB_MAC_CLEAR_IO_IN_USE()    (MAC_CTX().mac_flags2 &= \
                                         ~ZB_MAC_IO_IN_USE_MASK)

#define ZB_MAC_SET_BEACON_REQ()     (MAC_CTX().mac_flags2 |= \
                                         ZB_MAC_BEACON_REQ_MASK)
#define ZB_MAC_GET_BEACON_REQ()     (MAC_CTX().mac_flags2 & \
                                     ZB_MAC_BEACON_REQ_MASK)
#define ZB_MAC_CLEAR_BEACON_REQ()   (MAC_CTX().mac_flags2 &= \
                                         ~ZB_MAC_BEACON_REQ_MASK)

#define ZB_MAC_SET_SCAN_TIMEOUT()   (MAC_CTX().mac_flags2 |= \
                                         ZB_MAC_SCAN_TIMEOUT_MASK)
#define ZB_MAC_GET_SCAN_TIMEOUT()   (MAC_CTX().mac_flags2 & \
                                     ZB_MAC_SCAN_TIMEOUT_MASK)
#define ZB_MAC_CLEAR_SCAN_TIMEOUT() (MAC_CTX().mac_flags2 &= \
                                         ~ZB_MAC_SCAN_TIMEOUT_MASK)

#define ZB_MAC_SET_POLL_REQUEST()   (MAC_CTX().mac_flags2 |= \
                                         ZB_MAC_POLL_REQUEST_MASK)
#define ZB_MAC_GET_POLL_REQUEST()   (MAC_CTX().mac_flags2 & \
                                     ZB_MAC_POLL_REQUEST_MASK)
#define ZB_MAC_CLEAR_POLL_REQUEST() (MAC_CTX().mac_flags2 &= \
                                         ~ZB_MAC_POLL_REQUEST_MASK)

#define ZB_MAC_SET_CHANNEL_ERROR_TEST()   (MAC_CTX().mac_flags |= \
                                               ZB_MAC_CHANNEL_ERROR_TEST_MASK)
#define ZB_MAC_GET_CHANNEL_ERROR_TEST()   (MAC_CTX().mac_flags & \
                                           ZB_MAC_CHANNEL_ERROR_TEST_MASK)
#define ZB_MAC_CLEAR_CHANNEL_ERROR_TEST() (MAC_CTX().mac_flags &= \
                                               ~ZB_MAC_CHANNEL_ERROR_TEST_MASK)

#define ZB_MAC_SET_TRANS_SPLEEPING()   (MAC_CTX().mac_flags2 |= \
                                            ZB_MAC_TRANS_SLP_MASK)
#define ZB_MAC_GET_TRANS_SPLEEPING()   (MAC_CTX().mac_flags2 & \
                                        ZB_MAC_TRANS_SLP_MASK)
#define ZB_MAC_CLEAR_TRANS_SPLEEPING() (MAC_CTX().mac_flags2 &= \
                                            ~ZB_MAC_TRANS_SLP_MASK)
