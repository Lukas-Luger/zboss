...
#define TRACE_ENABLED_(mask, \
                       lev) ((lev) <= ZB_TRACE_LEVEL && \
                             ((mask) & ZB_TRACE_MASK))
/**
...
void zb_trace_msg_8051(zb_char_t ZB_IAR_CODE *file_name, zb_int_t line_number,
                       zb_uint8_t args_size, ...) ZB_SDCC_REENTRANT;
#define _T1(s, l, \
            args) if ((zb_int_t)ZB_TRACE_LEVEL >= (zb_int_t)l && \
                      ((s) & ZB_TRACE_MASK)) zb_trace_msg_8051 args
 ...
 */
#define TRACE_ARG_64(a) (zb_uint8_t)((a)[7]), (zb_uint8_t)((a)[6]), \
    (zb_uint8_t)((a)[5]), (zb_uint8_t)((a)[4]), (zb_uint8_t)((a)[3]), \
    (zb_uint8_t)((a)[2]), (zb_uint8_t)((a)[1]), (zb_uint8_t)((a)[0])
...
#define TRACE_ARG_64(a) ((zb_addr64_struct_t ZB_SDCC_XDATA * \
                          ZB_SDCC_XDATA)a)->a1, \
    ((zb_addr64_struct_t ZB_SDCC_XDATA * ZB_SDCC_XDATA)a)->a2, \
    ((zb_addr64_struct_t ZB_SDCC_XDATA * ZB_SDCC_XDATA)a)->a3, \
    ((zb_addr64_struct_t ZB_SDCC_XDATA * ZB_SDCC_XDATA)a)->a4
