...
#define ZB_NSDU_MAX_LEN (MAX_PHY_FRM_SIZE - \
                         (ZB_NWKC_MAC_FRAME_OVERHEAD + \
                          ZB_NWKC_MIN_HEADER_OVERHEAD))
...
#define ZB_SET_NODE_DESC_COMPLEX_DESC_AVAIL(desc, value)         \
    ((desc)->node_desc_flags &= \
         (zb_uint16_t) ~ZB_NODE_DESC_COMPLEX_DESC_AVAIL_MASK, \
...
#define ZB_SET_NODE_DESC_USER_DESC_AVAIL(desc, value)                 \
    ((desc)->node_desc_flags &= \
         (zb_uint16_t) ~ZB_NODE_DESC_USER_DESC_AVAIL_MASK,    \
...
#define ZB_SET_POWER_DESC_CUR_POWER_MODE(desc, value)               \
    ((desc)->power_desc_flags &= \
         (zb_uint16_t) ~ZB_POWER_DESC_CUR_POWER_MODE_MASK, \
...
#define ZB_SET_POWER_DESC_AVAIL_POWER_SOURCES(desc, value)               \
    ((desc)->power_desc_flags &= \
         (zb_uint16_t) ~ZB_POWER_DESC_AVAIL_POWER_SOURCES_MASK, \
...
#define ZB_SET_POWER_DESC_CUR_POWER_SOURCE(desc, value)               \
    ((desc)->power_desc_flags &= \
         (zb_uint16_t) ~ZB_POWER_DESC_CUR_POWER_SOURCE_MASK, \
...
#define ZB_SET_POWER_DESC_CUR_POWER_SOURCE_LEVEL(desc, value)               \
    ((desc)->power_desc_flags &= \
         (zb_uint16_t) ~ZB_POWER_DESC_CUR_POWER_SOURCE_LEVEL_MASK, \
...
#define ZB_SET_NODE_DESCRIPTOR(logical_type_p, frequence_band_p, \
                               mac_capability_flags_p, manufacturer_code_p, \
                               max_buf_size_p, max_incoming_transfer_size_p, \
                               server_mask_p, \
                               max_outgoing_transfer_size_p, \
                               desc_capability_field_p) \
    (ZB_SET_NODE_DESC_LOGICAL_TYPE(ZB_ZDO_NODE_DESC(), (logical_type_p)), \
     ...
     ZB_ZDO_NODE_DESC()->max_incoming_transfer_size = \
         (zb_uint16_t)(max_incoming_transfer_size_p), \
     ZB_ZDO_NODE_DESC()->server_mask = (zb_uint16_t)(server_mask_p),                \
     ZB_ZDO_NODE_DESC()->max_outgoing_transfer_size = \
         (zb_uint16_t)(max_outgoing_transfer_size_p), \
     ZB_ZDO_NODE_DESC()->desc_capability_field = \
         (zb_uint8_t)(desc_capability_field_p))
 ...
 */
void zb_set_ffd_node_descriptor(
    zb_logical_type_t device_type) ZB_SDCC_REENTRANT;
