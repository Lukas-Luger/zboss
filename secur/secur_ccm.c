...
static const zb_uint8_t shift_rows_table_inv[] =
...
{ 0x63, 0x7c, 0x77, 0x7b, 0xf2, 0x6b, 0x6f, 0xc5, 0x30, 0x01, 0x67, 0x2b, 0xfe,
  ...
  0x54, 0xbb, 0x16 };
static const zb_uint8_t lookup_sbox_inv[] = {
...
{ 0x00, 0x03, 0x06, 0x05, 0x0c, 0x0f, 0x0a, 0x09, 0x18, 0x1b, 0x1e, 0x1d, 0x14,
  ...
  0x1c, 0x19, 0x1a };
static const zb_uint8_t lookup_g9[] = {
...
static const zb_uint8_t lookup_g11[] = {
...
static const zb_uint8_t lookup_g13[] = {
...
static const zb_uint8_t lookup_g14[] = {
...
static void sub_bytes_inv(zb_uint8_t *a, int n)
{
    int i;
...
static void expand_key(const zb_uint8_t *key, zb_uint8_t *keys)
{
...
static void shift_rows_inv(zb_uint8_t *state)
{
    int i;
    zb_uint8_t temp[16];
...
// http://en.wikipedia.org/wiki/Rijndael_mix_columns
static void mix_col_inv(zb_uint8_t *state)
{
    zb_uint8_t a0 = state[0];
    zb_uint8_t a1 = state[1];
    zb_uint8_t a2 = state[2];
...
static void mix_cols_inv(zb_uint8_t *state)
{
    mix_col_inv(state);
    mix_col_inv(state + 4);
    mix_col_inv(state + 8);
