    ...
    zb_buf_t *crypted_text)
{
    ...
    auth_trans(ZB_CCM_M, key, nonce, string_a, string_a_len, string_m,
               string_m_len, t);

    ZB_BUF_INITIAL_ALLOC(crypted_text, string_a_len + string_m_len + ZB_CCM_M,
                         c_text);
    /* A.2.3Encryption Transformation */
    encrypt_trans(ZB_CCM_M, key, nonce, string_m, string_m_len, t,
                  c_text + string_a_len);
    ...
    zb_ushort_t string_c_len)
{
    ...
    if (!ZB_MEMCMP(decrypted_text + decrypted_text_len, t, ZB_CCM_M)) {
        ZB_MEMCPY(ZB_BUF_BEGIN(
                      buf) + string_a_len, decrypted_text, decrypted_text_len);
        return RET_OK;
    }
    else {
...
static zb_uint8_t shift_rows_table[] =
{ 0, 5, 10, 15, 4, 9, 14, 3, 8, 13, 2, 7, 12, 1, 6, 11 };
static zb_uint8_t lookup_rcon[] =
{ 0x8d, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36, 0x6c, 0xd8,
  0xab, 0x4d, 0x9a };
static zb_uint8_t lookup_sbox[] =
...
{ 0x00, 0x02, 0x04, 0x06, 0x08, 0x0a, 0x0c, 0x0e, 0x10, 0x12, 0x14, 0x16, 0x18,
  ...
   };
static zb_uint8_t lookup_g3 [] =
{ 0x00, 0x03, 0x06, 0x05, 0x0c, 0x0f, 0x0a, 0x09, 0x18, 0x1b, 0x1e, 0x1d, 0x14,
  ...
  0x34, 0x31, 0x32, 0x23, 0x20, 0x25, 0x26, 0x2f, 0x2c, 0x29, 0x2a, 0x0b,
  0x08, 0x0d, 0x0e, 0x07, 0x04, 0x01, 0x02, 0x13, 0x10, 0x15, 0x16, 0x1f,
  0x1c, 0x19, 0x1a };
