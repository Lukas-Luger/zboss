...
zb_short_t aps_check_dups(zb_uint16_t src_addr,
                          zb_uint8_t aps_counter) ZB_SDCC_REENTRANT
{
    ...
    if (zb_address_by_short(src_addr,
        ...
        TRACE_MSG(TRACE_APS2,
                  "dup detection: is_dup %hd addr 0x%x ref %hd aps_counter %hd clock %hd",
                  (FMT__H_D_H_H_H,
        ...
        if (!ZG->aps.dups_alarm_running) {
            ...
            ZB_SCHEDULE_ALARM(zb_aps_check_timer_cb, 0,
