...
void get_mac_addr_16bit_addr_fileds(uint8_t *ptr,
                                    mac_addr_16bit_addr_fileds_t *ret);
void get_mac_addr_64bit_addr_fileds(uint8_t *ptr,
                                    mac_addr_64bit_addr_fileds_t *ret);
void get_mac_frame_control(uint8_t *ptr, mac_frame_control_t *ret);
void get_mac_frame_format_16bit_addr(uint8_t *ptr,
                                     mac_frame_format_16bit_addr_t *ret);
void get_mac_frame_format_64bit_addr(uint8_t *ptr,
                                     mac_frame_format_64bit_addr_t *ret);
