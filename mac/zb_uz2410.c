...
/* if uz2400 is sleeping, it still can produce an interrupt, and we can even handle it,
   but we can't read/write fifo or some long regs */
    ...
    if (ZB_MAC_GET_INDIRECT_DATA_REQUEST()) {
        ...
        TRACE_MSG(TRACE_COMMON2, "TXNTRIG read: 0x%hx",
    ...
    ZB_MAC_START_IO();
    {
        ...
        *data_ptr = (short_addr << 1);
        ...
        ZG->mac.mac_ctx.rw_reg.value.byte_value =
            *((zb_uint8_t ZB_XDATA *)(short_addr | ZB_SHORT_REGS_BASE));
                            ...
                            zb_uint8_t byte_value) ZB_SDCC_REENTRANT
{
    ...
    ZB_MAC_START_IO();
    {
        ...
        /* actual i/o */
        *((zb_uint8_t ZB_XDATA *)(short_addr |
                                  ZB_SHORT_REGS_BASE)) = byte_value;
    }
    ZB_MAC_STOP_IO();
    TRACE_MSG( TRACE_MAC2, "-zb_mac_short_write_reg", (FMT__0));
}
...
void zb_mac_long_read_reg(zb_uint16_t long_addr) ZB_SDCC_REENTRANT
{
    ...
    ZB_MAC_START_IO();
    {
        ...
        /* actual i/o here */
        ZG->mac.mac_ctx.rw_reg.value.byte_value =
            *((zb_uint8_t ZB_XDATA *)(long_addr | ZB_LONG_REGS_BASE));
                          ...
                          zb_buf_t *buf) ZB_SDCC_REENTRANT
{
    ...
    /* actual i/o here */
    ZB_MEMCPY((zb_uint8_t ZB_XDATA *)ZB_NORMAL_FIFO_ADDR, ZB_BUF_BEGIN(
                  buf), ZB_BUF_LEN(buf));
